...
if ( !class_exists('TFButton') )
{
	class TFButton
	{
		...
		return sprintf('<div class="wpfollowbutton"><a href="http://twitter.com/%s" class="twitter-follow-button" data-show-count="%s" data-button="grey" data-text-color="#C3C3C3" data-link-color="#30C0FF" data-lang="%s">Follow @twitter</a>
